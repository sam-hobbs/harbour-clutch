...
//#include "exif/exif.h" // TODO - add this back in by building with exif-devel - used to get orientations for files
    ...
    if (directory.exists())
    {
        ...
        foreach (const QFileInfo &fileInfo, list)
        {
            ...
            if (fileInfo.isFile())
            {
                ...
                QStringList mime = entry.type.split('/');
                QString category = mime.first();
                QString type = mime.last();
                ...
                int orientation = 0;
                //Exif::getExifOrientation(filePath, &orientation); // TODO - add this functionality back in by building with exif-devel
